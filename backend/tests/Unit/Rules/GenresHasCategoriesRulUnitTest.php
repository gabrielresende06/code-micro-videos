...
class GenresHasCategoriesRulUnitTest extends TestCase {
    ...
    public function testCategoriesIdField() {
        ...
        $this->assertEqualsCanonicalizing([1, 2], $categoriesId->toArray());
    }
    ...
    public function testGenresIdValue() {
        ...
        $this->assertEqualsCanonicalizing([1, 2], $genreId->toArray());
    }
