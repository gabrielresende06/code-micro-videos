...
trait TestSaves {
    ...
    protected function assertStore(
        array $sendData, array $testData, array $testJson = null
    ): TestResponse {
        ...
        $this->assertJsonResponseContent($response, $testData, $testJson);
    ...
    private function assertJsonResponseContent(TestResponse $response, array $testData, array $testJson = null) {
        $testResponse = $testJson ?? $testData;
